...
const ListView: React.FC<ListViewProps> = ({ onOpenCreateModal }) => {
  ...
  const getStatusIcon = (status: string) => {
    ...
    switch (status) {
      case "en-attente":
        return (
          <CircleEllipsis size={14} className={`${baseClass} text-white`} />
        );
      case "ouvert":
      ...
      case "termine":
        return (
          <CircleCheckBig size={14} className={`${baseClass} text-white`} />
        );
      default:
        return (
          <CircleEllipsis size={14} className={`${baseClass} text-white`} />
                      ...
                      statusTasks.map((task) => {
                        ...
                        return (
                          <div
                              ...
                              editForm.priority !== undefined ? (
                                <div className="flex items-center space-x-1">
                                  <select
                                    ...
                                    onChange={(e) =>
                                      setEditForm({ priority: e.target.value })
                                    }
                              ...
                              editForm.status !== undefined ? (
                                <div className="flex items-center space-x-1">
                                  <select
                                    ...
                                    onChange={(e) =>
                                      setEditForm({ status: e.target.value })
                                    }
                                    className="border border-gray-300 rounded px-1 py-0.5 text-xs w-full"
                                    autoFocus>
                                ...
                                <div
                                  ...
                                  <div
                                    className={`flex items-center space-x-1 ${taskStyles.bgback} px-2 py-1 rounded-full`}>
                            ...
                            {/* Demandeur */}
                            <div className="col-span-1 text-gray-500">AO</div>
